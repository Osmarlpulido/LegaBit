...
-- CreateEnum
CREATE TYPE "OrganizationType" AS ENUM ('LAW_FIRM', 'STARTUP', 'SME', 'EDUCATIONAL');

-- CreateEnum
CREATE TYPE "MembershipRole" AS ENUM ('organization_owner', 'admin', 'legal_operator', 'educator', 'student', 'client', 'community_moderator');
