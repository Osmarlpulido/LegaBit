...
function SocialButton({
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:border-legabit-petrol hover:text-legabit-petrol"
    >
      {children}
...
export function SocialLinks() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <SocialButton href={discord} label="Discord Legabit">
        ...
        <span aria-hidden>Discord</span>
      </SocialButton>
      <SocialButton href={telegram} label="Telegram Legabit">
        <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      <SocialButton href={youtube} label="Canal de YouTube Legabit">
        <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
