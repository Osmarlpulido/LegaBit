...
| Phase 3 — MongoDB/newsletter migration | In progress | Contracts, consent evidence, privacy-safe idempotency/rate limiting, versioned validator/index migrations, real-Mongo concurrency tests, local replica-set orchestration, backend/frontend cutover, and local journey verification are implemented; managed provisioning, retention/deletion policy, backup/recovery, and operational verification remain |
