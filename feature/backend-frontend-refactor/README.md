...
| Market-data extraction | In progress | Contracts, `/api/v1/markets`, resilient CoinGecko access, tests, and dashboard client cutover are implemented; the legacy route remains for rollback pending production observation |
